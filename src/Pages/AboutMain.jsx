        ...
        <div className="flex gap-5 flex-col pt-10 text-green-600">
          ...
          <div className="grid md:gap-10 gap-5 sm:grid-cols-2 ">
            <div className="bg-white rounded-lg flex flex-col">
              ...
              <p className="text-gray-600 font-bold pb-5">Aquarium Construction and Design</p>
            ...
            <div className="bg-white rounded-lg flex flex-col">
              ...
              <p className="text-gray-600 font-bold pb-5">Aquaculture</p>
            ...
            <div className="bg-white rounded-lg flex flex-col">
              ...
              <p className="text-gray-600 font-bold pb-5">Fish Feed Formulation and Production</p>
            ...
            <div className="bg-white rounded-lg flex flex-col">
              ...
              <p className="text-gray-600 font-bold pb-5">Fish Processing</p>
