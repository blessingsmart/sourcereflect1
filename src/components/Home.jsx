...
export const Home = () => {
  return (
    <div className='h-screen bg-gradient-to-r from-green-600 to-lime-600'>
      <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center Pt-5 h-full px-4 md:flex-row md:gap-32'>
            ...
            <div className='flex flex-col sm:flex-row gap-10 mt-10 md:mt-40 md:pt-56 bg-cover bg-center' style={{ heroImage: `url(${heroImage})` }}>
                <a href={"https://www.linkedin.com/in/popoola-samson-343129b9"} 
                                target='_blank'
                ...
                <a href={"https://www.linkedin.com/in/adedoyin-solomon-3b596b19a"} 
                                target='_blank'
                                rel='noopener noreferrer'
                                className='relative'>
                     <div className='bg-white h-60 w-60 p-4 rounded-lg'>
